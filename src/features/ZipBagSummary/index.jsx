            ...
            <ScanZipBagWrapper>
                ...
                <Box className="formContainer" component="form" autoComplete="off">
                    <Box className="InnerContainer">
                        <Typography variant="h2" className="nPagHeader">{Constants.PAGE_HEADER.ZIP_BAG_SUMMARY}</Typography>
                        <Typography variant="p" display="block" align="center">Zip Bag ID : <b>ZIP0123</b></Typography>
                        <Typography variant="p" display="block" align="center">Specimens : <b>13</b></Typography>
